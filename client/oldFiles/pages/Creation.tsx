...
import { PackingListFormType } from "../../oldFiles/interfaces/PackingListForm";
    ...
    <div className="card w-96 shadow-xl card-bordered mx-auto">
      <div className="card-body items-center text-center">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="card-title justify-center mt-10">
            Select Categories
          </div>
          <label className="form-control w-full max-w-xs">{items}</label>
